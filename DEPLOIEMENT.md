# Déploiement de Budget 4.1.0

1. Remplacer l’ensemble des fichiers de la version publiée par le contenu du dossier V4.1.
...
4. Ouvrir une première fois l’application en ligne. Le service worker `budget-v4.1.0` remplace alors l’ancien cache.
